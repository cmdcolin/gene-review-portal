...
// from a jbrowse-components checkout, and its entry point sits beside whichever
// one it is.
export function captureBin() {
  ...
  try {
    ...
    throw new Error(
      '@jbrowse/capture did not resolve. Run `pnpm install`, or pass --no-capture to build the portal without pictures.',
    )
  }
